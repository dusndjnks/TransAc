...
const Footer = () => {
  return (
    <footer className="w-full bg-[#f0fff4] py-16 text-gray-700 min-mt-1"> {/* Light green background */}
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="mx-auto max-w-xs">
            ...
            <div className="space-y-2">
              <p className="flex items-center justify-center">
                <i className="fa fa-phone mr-2 text-green-600"></i>
              ...
              <p className="flex items-center justify-center">
                ...
                <a href="mailto:service@coolbreeze.com" className="hover:text-green-600 transition-colors">
          ...
          <div className="mx-auto max-w-xs">
            ...
            <div className="flex justify-center space-x-4 mt-4 text-green-600">
              <a href="#" className="hover:text-green-800 transition-colors" aria-label="Facebook">
                <i className="fa fa-facebook text-xl"></i>
              </a>
              <a href="#" className="hover:text-green-800 transition-colors" aria-label="Instagram">
                <i className="fa fa-instagram text-xl"></i>
              </a>
              <a href="#" className="hover:text-green-800 transition-colors" aria-label="Google Reviews">
        ...
        {/* Accreditation */}
        <div className="mt-12 pt-6 border-t border-green-200 text-center text-sm text-gray-500">
