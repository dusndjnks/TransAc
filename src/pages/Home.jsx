...
const heroImages = [
  ...
  "https://images.pexels.com/photos/29252367/pexels-photo-29252367.jpeg",
  homepage6,
  homepage2,
];
    ...
    <div className="font-sans text-gray-800">
      ...
      <section id="about" className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="w-full md:w-1/2 relative rounded-lg overflow-hidden shadow-md bg-gray-100">
              <img src={homepage4} alt="Our team at work" className="w-full h-auto object-cover" />
      ...
      <section className="relative min-h-[60vh] bg-[#1E2A38] flex items-center">
        <div className="absolute inset-0">
          <img src={homepage1} alt="Showroom" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-[#1E2A38]/80" />
        </div>

        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-semibold text-white mb-4">Our Showrooms</h2>
            <p className="text-[#F1F5F9] max-w-2xl mx-auto">Visit our premium showrooms to experience our cooling solutions firsthand.</p>
          </div>
