...
import Fllor from "../Daikinx/daikin/Floor.png"

const categories = [
	{
		name: "Daikin Floor Standing AC Series",
		products: [
			{
				title: "Daikin FVQ125CRV16",
				image: Fllor,
				features: [
		...
		<div className="font-sans">
			<section className="bg-bg-dark py-24 md:py-40 text-center text-white">
				<h1 className="text-4xl md:text-5xl font-bold text-primary font-display">
					Daikin – Floor Standing ACs
				</h1>
			</section>

			<div className="py-14 px-6 md:px-16 lg:px-40 bg-white text-center">
				<p className="max-w-3xl mx-auto text-gray-700 text-lg leading-relaxed">
					Discover Daikin’s floor standing air conditioners, designed for
					powerful cooling, flexible installation, and easy maintenance in
					commercial and large residential spaces.
				</p>
			</div>
