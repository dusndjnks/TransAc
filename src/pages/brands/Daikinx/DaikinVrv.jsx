...
import Vrv1 from "../Daikinx/daikin/vrv (1).png"
import Vrv2 from "../Daikinx/daikin/vrv (2).png";
import Vrv3 from "../Daikinx/daikin/vrv (3).png";

const categories = [
  {
    name: "Daikin VRV AC Series",
    products: [
      {
        title: "Daikin VRV X (RXQ Series)",
        image: Vrv1 , 
        features: [
          "Next-gen Variable Refrigerant Temperature (VRT) inverter control technology",
          "High energy efficiency with advanced scroll compressors",
          "Wide capacity range: 6 HP to 60 HP, ideal for all commercial needs",
          "Silent operation and robust reliability",
          "Supports long piping length and design flexibility",
        ],
      },
      {
        title: "Daikin VRV Home (RXYRQ Series)",
        image: Vrv2 , 
        features: [
          "Tailored for homes, villas, and small offices",
          "Compact & aesthetic outdoor unit design",
          "Individual zone control for personalized comfort",
          "Efficient & quiet swing compressor",
          "Wide range: 4, 5, 6 HP outdoor units",
        ],
      },
      {
        title: "Daikin VRV Indoor Units (Cassette/Ducted/Wall Mounted)",
        image: Vrv3 ,
        features: [
          "Multiple stylish indoor unit options: Cassette, Ducted, Floor Standing, Wall Mounted",
          "Uniform, powerful airflow for large and small rooms",
          "Advanced air purification for healthy indoor climate",
          "Discreet installation for modern interiors",
          "Compatible with VRV X and VRV Home systems",
        ],
      },
    ],
  },
		...
		<div className="font-sans">
			...
			<div className="py-14 px-6 md:px-16 lg:px-40 bg-white text-center">
				<p className="max-w-3xl mx-auto text-gray-700 text-lg leading-relaxed">
					Discover Daikin’s VRV (Variable Refrigerant Volume) air conditioning
					systems, engineered for large buildings and luxury homes, offering
					flexible installation, energy efficiency, and advanced climate control.
				</p>
			</div>
